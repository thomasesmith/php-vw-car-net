...
if (file_exists($authFilename)) {
    ...
    try {
        // If you don't have any tokens saved, perform an authenticate() with your Car-Nat credentials
...
// The setSaveCallback() allows you to set a callback function to execute whenever the $Auth object gets 
// new tokens or refreshed tokens, so it's a good place to put the code that saves your token values 
// somewhere persistenly. In this example, I just serialize the $Auth object and save it to a flat file.
